package com.qy.test.repository;
...
import com.qy.test.domain.PersistentAuditEvent;
...
import static com.qy.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
